...
internal class ReviewsController(ReviewService reviewService) : ControllerBase
{
    ...
    {
        ResponseData<PagedResult<ReviewResponse>> response = await reviewService.GetAllAsync(filter);
    ...
    {
        ResponseData<ReviewResponse> response = await reviewService.GetByIdAsync(id);
        return StatusCode(response.StatusCode, response);
    }
    ...
    {
        ResponseData<ReviewResponse> response = await reviewService.ApproveAsync(id, UserId, Ip, Ua);
        return StatusCode(response.StatusCode, response);
    }
    ...
    {
        ResponseData<ReviewResponse> response = await reviewService.RejectAsync(id, request, UserId, Ip, Ua);
        return StatusCode(response.StatusCode, response);
    }
    ...
    {
        ResponseData<bool> response = await reviewService.DeleteAsync(id, UserId, Ip, Ua);
        return StatusCode(response.StatusCode, response);
    }
}
